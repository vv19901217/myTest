...
import cn.sinosoft.myokhttp.body.ProgressRequestBody;
import cn.sinosoft.myokhttp.body.ResponseProgressBody;
import cn.sinosoft.myokhttp.response.DownloadResponseHandler;
import cn.sinosoft.myokhttp.response.GsonResponseHandler;
import cn.sinosoft.myokhttp.response.IResponseHandler;
import cn.sinosoft.myokhttp.response.JsonResponseHandler;
import cn.sinosoft.myokhttp.response.RawResponseHandler;
import cn.sinosoft.myokhttp.util.LogUtils;
import cn.sinosoft.myokhttp.util.SharedPreferencesUtils;
import okhttp3.Call;
...
public class MyOkHttp {
     ...
     * @param responseHandler 回调
     */
    public void upload(String token,String url, Map<String, File> files, final IResponseHandler responseHandler) {
        upload( token,null, url, null, files, responseHandler);
    }
     ...
     * @param responseHandler 回调
     */
    public void upload(String token,String url, Map<String, String> params, Map<String, File> files, final IResponseHandler responseHandler) {
        upload( token,null, url, params, files, responseHandler);
    }
     ...
     * @param responseHandler 回调
     */
    public void upload(String token,Context context, String url, Map<String, File> files, final IResponseHandler responseHandler) {
        upload( token,context, url, null, files, responseHandler);
    }
     ...
     * @param responseHandler 回调
     */
    public void upload(String token,Context context, String url, Map<String, String> params, Map<String, File> files, final IResponseHandler responseHandler) {
